...
public class VaadinConnectOAuthConfigurerTest {
   ...
   * webcontext. One of these of those classes should implement the
   * {@link TestRunner} interface
   */
  @Parameters(name = "{index}: {0}")
  public static List<Object[]> parameters() {
    return Arrays.asList( // @formatter:off
      new Object[][] {
        { "Should fail if VaadinConnectOAuthConfigurer has not been loaded",
        ...
        { "Should not produce a valid token if UserDetailsService is not provided",
          null,
          Arrays.asList(EnableSpringWebSecurity.class, InvalidTokenTest.class) },
  ...
  @Configuration
  protected static class ConfiguredVaadinOauth {
    @Bean
