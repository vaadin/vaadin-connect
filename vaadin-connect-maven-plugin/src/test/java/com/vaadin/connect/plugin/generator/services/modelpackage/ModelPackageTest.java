 ...
 * the License.
 */
package com.vaadin.connect.plugin.generator.services.modelpackage;
...
import com.vaadin.connect.plugin.generator.services.modelpackage.subpackage.Account;

public class ModelPackageTest extends AbstractServiceGenerationTest {

  public ModelPackageTest() {
    super(Arrays.asList(ModelPackageService.class, SubModelPackageService.class,
        Account.class));
  }
