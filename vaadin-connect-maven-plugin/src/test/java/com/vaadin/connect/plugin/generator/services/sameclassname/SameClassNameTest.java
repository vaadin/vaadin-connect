...
import com.vaadin.connect.plugin.generator.services.sameclassname.subpackage.SameClassNameModel;
import com.vaadin.connect.plugin.generator.services.sameclassname.subpackage.SubProperty;

public class SameClassNameTest extends AbstractServiceGenerationTest {

  public SameClassNameTest() {
    super(Arrays.asList(SameClassNameService.class, SameClassNameModel.class,
        SubProperty.class));
  }
