...
Vaadin Connect is a bridge between Java backend services and Single Page
Application frontend.

The Vaadin Connect collection of tools and libraries includes:

- `vaadin-connect` Java library providing stateless backend services, based on
  Spring Boot.
...
The `base-starter-connect` example application provides the basic structure of a
new application made with Vaadin Connect.
